        ...
        <div className="flex flex-col gap-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="font-bold text-slate-800 dark:text-[#7dcfff] hover:text-cyan-600 dark:hover:text-[#38bdf8] transition-colors focus:outline-hidden focus:ring-1 focus:ring-cyan-500 rounded-xs flex items-center gap-1.5 group cursor-pointer"
            >
              <span className="text-cyan-600 dark:text-[#38bdf8] group-hover:-translate-y-0.5 transition-transform">
                [SYS]
              </span>
